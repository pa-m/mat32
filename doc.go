...
// package mat32 provides implementations of float64 and complex128 matrix
...
// in gonum/blas/blas32 and gonum/lapack/lapack64 and their complex equivalents.
// By default, blas32 and lapack64 call the native Go implementations of the
...
// through blas32, so if a cgo BLAS implementation is registered, the lapack64
...
// blas32.General, blas32.Gemm (general matrix multiplication) is called, while
// instead if b is a RawSymmetricer blas32.Symm is used (general-symmetric
// multiplication), and if b is a *VecDense blas32.Gemv is used.
//
...
// blas32 and lapack64 may be used to call the behavior directly.
//
